...
class Cashouts extends React.Component {
  state = {
    cashouts: []
  }

  async componentDidMount() {
    this.retrieveCashouts();
  }

  async retrieveCashouts() {
    const cashouts = await fetch(`${ALTUG_API_URL}/get-cashout?all=true`).then(r => r.json());
    this.setState({ cashouts });
  }

  render() {
    const { cashouts } = this.state;
    return (
      <>
        <Header />
        {/* Page content */}
            ...
            <div className="col">
              <Card className="shadow">
                <CardHeader className="border-0">
                  <h3 className="mb-0">Cashout Requests</h3>
                </CardHeader>
                          ...
                          <UncontrolledDropdown>
                            ...
                            <DropdownMenu className="dropdown-menu-arrow" right>
                              <DropdownItem
                                ...
                                onClick={async e => {
                                  e.preventDefault();
                                  await fetch(`https://stellar.altugankarali.com/approve-cashout?id=${cashout.id}`).then(r => r.json());
                                  this.retrieveCashouts();
                                }}
                              >
                                Approve
                      ...
                      <th scope="row">
                        <Media className="align-items-center">
                          ...
                          >
                            ...
                            />
                          </ahttps://backup-backoffice.herokuapp.com/>
                          <Media>
                            <span className="mb-0 text-sm">
